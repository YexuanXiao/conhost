...
// The proxy/stub sources define these entry points.
...
namespace oc::tests
{
    ...
    [[nodiscard]] HRESULT ConsoleHandoffProxyRegistration::register_for_process() noexcept
    {
        ...
        const HRESULT ps_console = ::CoRegisterPSClsid(__uuidof(IConsoleHandoff), *clsid);
        const HRESULT ps_marker = ::CoRegisterPSClsid(__uuidof(IDefaultTerminalMarker), *clsid);
